...
Lazy evaluation of results? If enabled, stops judging as soon as a highest priority result is found, otherwise always all testcases will be judged. On request will not auto-start judging. Analyst mode tries to judge only interesting testcases. 
...
Is this system running as a shadow system? See :doc:`the chapter on running DOMjudge as a shadow system<shadow>` for more information.
